      ...
      const sendOrderConfirmationEmail = async () => {
        try {
          const templateParams = {
            ...
            customer_email: customerDetails.email, // Customer's actual email
            business_email: 'rimaorganiccosmetics@gmail.com', // Business owner's email
            ...
            items_html: order.items.map((item: { name: string; quantity: number; price: number }) => `<li>${item.name} x ${item.quantity} (₹${item.price * item.quantity})</li>`).join(''),
