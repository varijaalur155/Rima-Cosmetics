                    ...
                    <div className="mt-4">
                      {paymentMethod === 'google-pay' && (
                        <p className="text-green-700 text-sm">
                          Pay using Google Pay UPI ID: <strong>your-upi-id@okhdfcbank</strong>. After payment, contact us on WhatsApp to confirm your order.
                        </p>
                      )}
                      {paymentMethod === 'phonepe' && (
                        <p className="text-green-700 text-sm">
                          Pay using PhonePe UPI ID: <strong>your-upi-id@ybl</strong>. After payment, contact us on WhatsApp to confirm your order.
                        </p>
                      )}
