...
const BUSINESS_WHATSAPP_NUMBER = '+919999999999'; // Replace with actual WhatsApp number
const BUSINESS_PHONEPE_ID = 'your_phonepe_id@ybl'; // Replace with actual PhonePe ID
const BUSINESS_GOOGLE_PAY_ID = 'your_gpay_id@okbiz'; // Replace with actual Google Pay ID
